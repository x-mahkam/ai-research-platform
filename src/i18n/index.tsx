...
const en: Dict = {
  ...
  'rebuild.title': 'AI: fix & rebuild the model',
  'rebuild.beta': 'experimental',
  'rebuild.warning':
    'The AI writes a COMSOL Java (LiveLink) script for your fix; the platform compiles and runs it to produce a corrected .mph. This is best-effort — it may not compile on every model. The generated code and full logs are shown so you can review or run it yourself.',
  'rebuild.instruction': 'Describe the fix to apply',
  'rebuild.placeholder': 'e.g. Add a fixed Temperature boundary condition of 300 K on the substrate base, and a 0.7 V Terminal / Ground pair on the two contacts.',
  'rebuild.launch': 'Generate & rebuild',
  'rebuild.status.generating': 'AI is writing the model script…',
  'rebuild.status.building': 'Compiling & running in COMSOL…',
  'rebuild.status.completed': 'Rebuilt',
  'rebuild.status.failed': 'Failed',
  'rebuild.done': 'New model written to: {path}',
  'rebuild.showCode': 'Show generated Java',
  'rebuild.showLogs': 'Show compile / run logs',
  'rebuild.err.instruction': 'Describe the fix you want applied.',
  'chat.welcome':
...
const uz: Dict = {
  ...
  'rebuild.title': 'AI: modelni tuzat va qayta qur',
  'rebuild.beta': 'eksperimental',
  'rebuild.warning':
    'AI sizning tuzatishingiz uchun COMSOL Java (LiveLink) skript yozadi; platforma uni kompilyatsiya qilib, ishga tushiradi va tuzatilgan .mph chiqaradi. Bu urinish — har modelда ishlamasligi mumkin. Yaratilgan kod va to‘liq loglar ko‘rsatiladi, siz ko‘rib chiqib o‘zingiz ham ishlata olasiz.',
  'rebuild.instruction': 'Qanday tuzatish kerakligini yozing',
  'rebuild.placeholder': 'masalan: Substrat pastki yuzasiga 300 K Temperature chegara sharti qo‘sh, va ikki kontaktga 0.7 V Terminal / Ground juftligini ula.',
  'rebuild.launch': 'Yaratib qayta qur',
  'rebuild.status.generating': 'AI model skriptini yozyapti…',
  'rebuild.status.building': 'COMSOL’da kompilyatsiya va ishga tushirilyapti…',
  'rebuild.status.completed': 'Qayta qurildi',
  'rebuild.status.failed': 'Xato',
  'rebuild.done': 'Yangi model yozildi: {path}',
  'rebuild.showCode': 'Yaratilgan Java kodini ko‘rsatish',
  'rebuild.showLogs': 'Kompilyatsiya / ishga tushirish loglarini ko‘rsatish',
  'rebuild.err.instruction': 'Qanday tuzatish kerakligini yozing.',
  'chat.welcome':
